...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/17 12:03:29 by sbalesme          #+#    #+#             */
/*   Updated: 2022/10/27 07:54:57 by sbalesme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	*load_img_textures(char *mapxpm, int i, t_game *game)
{
	...
	tmp = NULL;
	if (!mapxpm || check_xpm(mapxpm, ".xpm", 4))
...
void	init_win(t_game *game)
{
	...
	{
		game->imgs_text = (int **)malloc(sizeof(int *) * 5);
		game->imgs[4] = NULL;
	}
	if (!game->imgs_text)
		printexit_perror(game, "OUTMAP");
